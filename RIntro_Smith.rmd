...
```{r}
subtract <- 10 - 1.5 #subtracting 1.5 from 10
power <- 1.3 + 1.789 # adding 1.3 to 1.789
print(subtract ^ power) # raising the subtract variable to the to power variable
```

4. Divide 5 by 2.5 then divide the answer by 4

```{r}
division <- 5/2.5 # dividing 5 by 2.5
print(division/4) #dividing the division variable by 4
```

5. Create an object (a variable!) called “obj1” which is the number 15

```{r}
obj1 <- 15 #creating object 'obj1'
```

6. Create an object called “obj2”" which is the answer to the sum of 100 + 25

```{r}
obj2 <- 100 + 25 #creating object 'obj2' that adds 100 + 25
```

7. Multiply “obj1” and “obj2” together and store the answer as another object called “obj3”

```{r}
obj3 <- obj1 * obj2 # multiplying 'obj1' & 'obj2' and assigning it to obj3
